...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['request'])) {
        ...
        if (isset($_POST['bloodGroup']) && (isset($_POST['bloodGroup']) == "")) {
            ...
            $sql = "INSERT INTO hms_project_database.btrequest (UID, Type, Specification) VALUES ($uid, '$request', '$bloodGroup');";
        } else {
            $organ = test_input($_POST['organ']);
            $sql = "INSERT INTO hms_project_database.btrequest (UID, Type, Specification) VALUES ($uid, '$request', '$organ');";
        }

        if (mysqli_query($conn, $sql)) {
            echo '<script>alert("Your request has been accepted. We will revert back soon.");</script>';
        } else {
