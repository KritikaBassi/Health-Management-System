...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['buid']) && isset($_POST['ouid']) && isset($_POST['vaccine']) && isset($_POST['status'])) {
        ...
        if (isset($_POST['reason']) && !empty($_POST['reason'])) {
            ...
            $sql = "INSERT INTO hms_project_database.vaccines (BUID, OUID, HID, Vaccine, Status, Reason) VALUES ($buid, $ouid, $hid, '$vaccine', '$status', '$reason');";
        } else {
            $name = test_input($_POST['name']);
            $dose = test_input($_POST['dose']);
            $sql = "INSERT INTO hms_project_database.vaccines (BUID, OUID, HID, Vaccine, Status, Dose, Name) VALUES ($buid, $ouid, $hid, '$vaccine', '$status', $dose, '$name');";
        }
        ...
        <section id="prescription" class="record-section">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF"]); ?>">
                ...
                <div class="form-field">
                    ...
                    <input type="number" id="OUID" name="ouid" required="" maxlength="12"
                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                </div>
                    ...
                    <div id="rest_div" style="display: none;">
                        ...
                        <div class="form-container">
                            <div class="form-field">
                                ...
                                <input type="number" id="DoseNo" name="dose" maxlength="2"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            </div>
                        </div><br>
                    </div>
                ...
                <center>
                    ...
                    <a href="./M_HealthInfo.php"><button class="btn">Go back</button></a>
                </center>
    </div>
    </form>
    </section>
