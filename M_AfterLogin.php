          ...
          <path
            ...
            <div class="col mb-3">
                ...
                <ul class="nav flex-column" style="margin-left: 10px;">
                    <li class="nav-item mb-2"><a href="./HealthRecords.php" class="nav-link p-0 text-body-secondary">Check Prescription</a></li>
                    <li class="nav-item mb-2"><a href="./HealthRecords.php" class="nav-link p-0 text-body-secondary">Medical History</a></li>
                    <li class="nav-item mb-2"><a href="./HealthRecords.php" class="nav-link p-0 text-body-secondary">Follow-up on the Doctor</a></li>
                    <li class="nav-item mb-2"><a href="./HealthRecords.php" class="nav-link p-0 text-body-secondary">Vaccination Record</a></li>
                    <li class="nav-item mb-2"><a href="./HealthRecords.php" class="nav-link p-0 text-body-secondary">Investigation Report</a></li>
                </ul>
            </div>
