...
<body>
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST['samplecollectionaddress']) && isset($_POST['reportouid']) && isset($_POST['sampleouid']) && isset($_POST['buid']) && isset($_POST['samplecollectiontime']) && !empty($_POST['samplecollectionaddress']) && !empty($_POST['reportouid']) && !empty($_POST['sampleouid']) && !empty($_POST['buid']) && !empty($_POST['samplecollectiontime'])) {
        ...
        $tempSql = "SELECT * FROM hms_project_database.invlft WHERE BUID = $buid AND SampleOUID = $sampleouid AND ReportOUID = $reportouid AND SampleCollectionAddress = $samplecollectionaddress AND SampleCollectionTime = '$samplecollectiontime';";
    ...
    ?><script>
                ...
                if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST['tsubmit'])) {
                    ...
                    if ($_POST['ALT'] != null) {
                        ...
                        $sql = "UPDATE hms_project_database.invlft SET ALT = $ALT WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['AST'] != null) {
                        $AST = test_input($_POST['AST']);
                        $sql = "UPDATE hms_project_database.invlft SET AST = $AST WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['ALP'] != null) {
                        $ALP = test_input($_POST['ALP']);
                        $sql = "UPDATE hms_project_database.invlft SET ALP = $ALP WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['GGPT'] != null) {
                        $GGPT = test_input($_POST['GGPT']);
                        $sql = "UPDATE hms_project_database.invlft SET GGPT = $GGPT WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['totalBilirubin'] != null) {
                        $totalBilirubin = test_input($_POST['totalBilirubin']);
                        $sql = "UPDATE hms_project_database.invlft SET totalBilirubin = $totalBilirubin WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['directBilirubin'] != null) {
                        $directBilirubin = test_input($_POST['directBilirubin']);
                        $sql = "UPDATE hms_project_database.invlft SET directBilirubin = $directBilirubin WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['indirectBilirubin'] != null) {
                        $indirectBilirubin = test_input($_POST['indirectBilirubin']);
                        $sql = "UPDATE hms_project_database.invlft SET indirectBilirubin = $indirectBilirubin WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }

                    if ($_POST['totalProtein'] != null) {
                        $totalProtein = test_input($_POST['totalProtein']);
                        $sql = "UPDATE hms_project_database.invlft SET totalProtein = $totalProtein WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['globulin'] != null) {
                        $globulin = test_input($_POST['globulin']);
                        $sql = "UPDATE hms_project_database.invlft SET Globulin = $globulin WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['albumin'] != null) {
                        $albumin = test_input($_POST['albumin']);
                        $sql = "UPDATE hms_project_database.invlft SET Albumin = $albumin WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['agRatio'] != null) {
                        $agRatio = test_input($_POST['agRatio']);
                        $sql = "UPDATE hms_project_database.invlft SET agRatio = $agRatio WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($_POST['AST_ALT'] != null) {
                        $AST_ALT = test_input($_POST['AST_ALT']);
                        $sql = "UPDATE hms_project_database.invlft SET AST_ALT = $AST_ALT WHERE BUID = $buid AND SampleCollectionTime = '$samplecollectiontime' AND SampleCollectionAddress = $samplecollectionaddress AND SampleOUID = $sampleouid AND ReportOUID = $reportouid;";
                        addData($conn, $sql);
                    }
                    if ($flag) {
