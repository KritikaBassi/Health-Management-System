...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['uid']) && isset($_POST['name']) && isset($_POST['contact_no']) && isset($_POST['address']) && isset($_POST['other'])) {
        ...
        $sql = "INSERT INTO hms_project_database.onlinesos (UID, Name, Contact, Address, Additional_Info) VALUES ($uid, '$name', '$contact_no', '$address', '$other');";

        if (mysqli_query($conn, $sql)) {
            echo "Your message has been received! Dispatching respond units.";
        } else {
            echo "Your message was not delivered. Error: " . mysqli_error($conn) . ".";
        }
        mysqli_close($conn);
    }
}
        ...
        <div class="col-md-7 col-lg-8 container" style="margin: 0 auto;">
            ...
            <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            <input type="number" name="contact_no" class="form-control" style="width: 100%;" id="floatingInput" placeholder="+XXXXXXXXXXXX" maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                        </div>
                    </div>
            ...
            <center>
                <form id="myForm" style="margin-top: 15px;">
                    ...
                    <button id="getHelpButton" type="button" class="btn btn-success">Get Help</button>
