...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['buid'])) {
        ...
        $sql = "SELECT * FROM hms_project_database.medical WHERE BUID = $buid";
...
<body>
    ...
    <br>
                ...
                <a href="./M_HealthInfo.php"><button class="w-20 btn btn-primary btn-lg my-3" type="submit">Go back</button></a>
            </center>
        </form>
        <br>
