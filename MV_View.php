...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['buid'])) {
        ...
        $sql = "SELECT Vaccine, Dose, Status, Reason FROM hms_project_database.vaccines AS V WHERE BUID = $buid AND Dose = (SELECT MAX(Dose) FROM hms_project_database.vaccines WHERE Vaccine = V.Vaccine) AND Dose <> 0;";
        ...
        <center><h1>Vaccination Record:</h1></center>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF"]); ?>">
                <div class="form-container">
                    ...
                    <center>
                        <input type="submit" value="View Vaccination" style="margin-right: 5px;">
                        <a href="./M_HealthInfo.php"><button class="w-20 btn btn-success btn-lg my-3" type="submit">Go
                                back</button></a>
                    </center>
                </div>
            </form>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    <table border="1">
                        <tr>
                            ...
                            <th style="font-weight: bold; padding: 10px;">Vaccine</th>
