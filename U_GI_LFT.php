<?php
    ...
    $sql = "SELECT * FROM hms_project_database.invlft WHERE BUID = $uid ORDER BY 'SampleCollectionTime' DESC;";
    if ((mysqli_num_rows(mysqli_query($conn, $sql))) > 0) {
        $result = mysqli_fetch_assoc(mysqli_query($conn, $sql));
        ...
        $sqlForAddress = "SELECT * FROM hms_project_database.hospitals WHERE HID = $SampleCollectionAddress;";
