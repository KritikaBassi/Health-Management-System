...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['buid']) && isset($_POST['sampleCollectionTime'])) {
        ...
        $_SESSION['tbuid'] = $buid;
        $sql = "SELECT * FROM hms_project_database.invxray WHERE BUID = $buid AND DateOfTest = '$sampleCollectionTime';";
                    ...
                    <table border="1">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo $pathtoXRAY; ?>" alt="X-RAY" width="500" height="600"></td>
